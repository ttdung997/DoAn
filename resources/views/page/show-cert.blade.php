    <!-- Modal -->
    {!! Form::open(['method'=> 'POST', 'route' => ['request.revoke', $certificate->id]]) !!}
                        ...
                        <div class="custom-control custom-radio mb-3">
                            @if ($certificate->status == 0)
                                {{-- <span class="mr-5 ml-5">
                                    <input type="radio" id="customRadio1" name="status" value="0" class="custom-control-input" {{ $certificate->status == 0 ? 'checked' : '' }}>
                                    <label class="custom-control-label" for="customRadio1"><span class='badge badge-pill badge-success'>Active</span></label>
                                </span>
                                <span>
                                    <input type="radio" id="customRadio2" name="status" value="1" class="custom-control-input" {{ $certificate->status == 1 ? 'checked' : '' }}>
                                    <label class="custom-control-label" for="customRadio2"><span class='badge badge-pill badge-warning'>Thu hồi</span></label>
                                </span> --}}
